...
print(name[-1])
#Task 4
list1 = [1,3,"Devansh",100,"Internship"]
print([list1])
#Task 5
...
print(list2)
#Task 7
tuple1 = [1,3,"Devansh",100,"Internship",50,"Python"]
print([tuple1])
...
print(tup)
#Task 9
d = {1:'Devansh', 2 : 'Patel', 'Internship': 'Python'}
print(type(d))
print('d[1] = ',d[1])
print('d[2] = ',d[2])
...
for tonum in range(0,int(input('Input the total number: '))):
    ...
    if a in dict:
        ...
        dict[a]=[b]
print(dict)
# Done all the basic tasks that were taught on Day 2
